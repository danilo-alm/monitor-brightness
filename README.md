...
A script that uses `python` and `xrandr` to control the brightness level of your monitor on a software level, allowing you to go lower it past the minimum hardware setting. <br/>
